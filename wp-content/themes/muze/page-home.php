	...
	<section class="pre-footer">
		<div class="container row">
			<div class="small-12 large-4 columns social-feed">
				<h3><i class="fa fa-twitter"></i> Tweets <span>by @HofflerPlace</span></h2>
				<?php echo do_shortcode( '[custom-twitter-feeds]' ); ?>
			</div>
			<div class="small-12 large-4 columns social-feed">
				<h3><i class="fa fa-instagram"></i> Instagram <span>by @HofflerPlace</span></h2>
				<?php echo do_shortcode( '[instagram-feed]' ); ?>
			</div>
			<div class="small-12 large-4 columns social-feed">
				<h3><i class="fa fa-facebook-square"></i> Facebook <span>by @HofflerPlace</span></h2>
