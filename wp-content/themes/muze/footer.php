			...
			<section>
				<div class="container row">
					<div class="small-12 medium-5 large-4 columns">
						<a class="footer-logo" alt="Muze Logo" href="<?php echo get_home_url(); ?>"><div class="footer-logo">Hoffler Place</div></a>
					...
					<div class="small-12 medium-7 large-2 columns">
                        ...
                        ?>
                        	<a href="mailto:hofflerplace@achliving.com">hofflerplace@achliving.com</a>
					</div>
				</div>
			</section>
		</footer>
